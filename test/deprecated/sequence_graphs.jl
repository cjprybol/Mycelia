...
#
# ```bash
# julia --project=. -e 'include("test/deprecated/sequence_graphs.jl")'
# ```
#
# And to turn this file into a jupyter notebook, run:
# ```bash
# julia --project=. -e 'import Literate; Literate.notebook("test/deprecated/sequence_graphs.jl", "test/deprecated", execute=false)'
# ```
