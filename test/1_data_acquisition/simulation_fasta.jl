...
Test.@testset "FASTA simulation and acquisition" begin
    ...
    Test.@testset "virus phiX174" begin
        ...
        rm(genome_result)
        phiX174_assembly_dataset = Mycelia.ncbi_genome_download_accession(
        ...
        Test.@test basename(phiX174_assembly_dataset.genome) ==
                   phiX174_assembly_id * "_ASM712v1_genomic.fna"
