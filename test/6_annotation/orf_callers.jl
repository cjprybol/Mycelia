...
#
# ```bash
# julia --project=. -e 'include("test/6_annotation/orf_callers.jl")'
# ```
#
# And to turn this file into a jupyter notebook, run:
# ```bash
# julia --project=. -e 'import Literate; Literate.notebook("test/6_annotation/orf_callers.jl", "test/6_annotation", execute=false)'
# ```
