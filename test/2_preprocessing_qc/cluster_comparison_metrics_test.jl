...
Test.@testset "Normalized Mutual Information (NMI)" begin
    ...
    Test.@testset "Error on mismatched lengths" begin
        Test.@test_throws ArgumentError Mycelia.normalized_mutual_information([1, 2, 3], [
            1, 2])
    end
end
...
Test.@testset "Adjusted Mutual Information (AMI)" begin
    ...
    Test.@testset "Error on mismatched lengths" begin
        Test.@test_throws ArgumentError Mycelia.adjusted_mutual_information([1, 2, 3], [
            1, 2])
    end
end
...
Test.@testset "Clustering Comparison Summary" begin
    ...
    Test.@testset "Error on mismatched lengths" begin
        Test.@test_throws ArgumentError Mycelia.clustering_comparison_summary([1, 2, 3], [
            1, 2])
    end
end
...
Test.@testset "Print Clustering Comparison" begin
    ...
    Test.@testset "Print to IOBuffer" begin
        ...
        io = IOBuffer()
        summary = Mycelia.print_clustering_comparison(
            labels1, labels2; name1 = "A", name2 = "B", io = io)
