...
Test.@testset "Rhizomorph Traversal and Polishing Tests" begin
    ...
    Test.@testset "Quality-weighted Traversal" begin
        ...
        graph = Mycelia.Rhizomorph.build_qualmer_graph(
            fastq_records, 4; dataset_id = "qual", mode = :singlestrand)
    ...
    Test.@testset "K-mer Graph Properties and Coverage" begin
        ...
        high_graph = Mycelia.Rhizomorph.build_kmer_graph(
            high_records, 3; dataset_id = "high", mode = :singlestrand)
        low_graph = Mycelia.Rhizomorph.build_kmer_graph(
            low_records, 3; dataset_id = "low", mode = :singlestrand)
    ...
    Test.@testset "Graph Construction Edge Cases" begin
        ...
        short_graph = Mycelia.Rhizomorph.build_kmer_graph(
            short_records, 4; dataset_id = "short", mode = :singlestrand)
        ...
        Test.@test FASTX.sequence(short_result.polished_record) ==
                   FASTX.sequence(short_fastq)
    end
    ...
    Test.@testset "Quality-weighted Evidence" begin
        ...
        high_graph = Mycelia.Rhizomorph.build_qualmer_graph(
            high_records, 4; dataset_id = "hq", mode = :singlestrand)
        low_graph = Mycelia.Rhizomorph.build_qualmer_graph(
            low_records, 4; dataset_id = "lq", mode = :singlestrand)
