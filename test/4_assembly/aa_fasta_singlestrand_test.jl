...
#
# ```bash
# julia --project=. -e 'include("test/4_assembly/aa_fasta_singlestrand_test.jl")'
# ```
#
# And to turn this file into a jupyter notebook, run:
# ```bash
# julia --project=. -e 'import Literate; Literate.notebook("test/4_assembly/aa_fasta_singlestrand_test.jl", "test/4_assembly", execute=false)'
# ```
