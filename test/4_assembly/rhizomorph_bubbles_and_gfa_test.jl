...
Test.@testset "Rhizomorph GFA round-trip (k-mer singlestrand)" begin
    mktempdir() do dir
        ...
        roundtrip = Mycelia.Rhizomorph.read_gfa_next(
            gfa_path, Kmers.DNAKmer{3}, Mycelia.Rhizomorph.SingleStrand)
...
Test.@testset "Rhizomorph GFA round-trip (k-mer doublestrand DNA)" begin
    mktempdir() do dir
        ...
        roundtrip = Mycelia.Rhizomorph.read_gfa_next(
            gfa_path, Kmers.DNAKmer{3}, Mycelia.Rhizomorph.DoubleStrand)
...
Test.@testset "Rhizomorph GFA round-trip (k-mer doublestrand RNA)" begin
    mktempdir() do dir
        ...
        roundtrip = Mycelia.Rhizomorph.read_gfa_next(
            gfa_path, Kmers.RNAKmer{3}, Mycelia.Rhizomorph.DoubleStrand)
...
Test.@testset "GFA metadata preservation - vertex count and edge count" begin
    mktempdir() do dir
        ...
        Test.@test length(collect(MetaGraphsNext.labels(roundtrip))) ==
