...
#
# Run with: julia --project=. -e 'include("test/4_assembly/dna_biosequence_doublestrand_quality_test.jl")'
...
Test.@testset "DNA BioSequence DoubleStrand Quality Graph" begin
    ...
    graph = Mycelia.build_biosequence_quality_graph(reads; graph_mode=Mycelia.DoubleStrand)
