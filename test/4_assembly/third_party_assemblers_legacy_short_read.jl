...
Test.@testset "Short Read Isolate Assembly" begin
    mktempdir() do dir
        ...
        simulated_reads = Mycelia.simulate_illumina_reads(
            fasta = ref_fasta, coverage = 10, rndSeed = 123, quiet = true)
        ...
        Test.@testset "Short Read Isolate Assembly - Spades" begin
            ...
            try
                result = Mycelia.run_spades(
                    fastq1 = fastq1, fastq2 = fastq2, outdir = spades_outdir,
        ...
        Test.@testset "Short Read Isolate Assembly - SKESA" begin
            ...
            try
                result = Mycelia.run_skesa(fastq1 = fastq1, fastq2 = fastq2,
                    outdir = skesa_outdir, threads = threads)
