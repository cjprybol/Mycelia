...
Test.@testset "Reinforcement Learning Framework Tests" begin
    ...
    Test.@testset "Environment Management" begin
        ...
        Test.@testset "Environment Reset" begin
            # Create test dataset
            test_reads = [
                FASTX.FASTQ.Record("read1", BioSequences.LongDNA{4}("ATCGATCGATCGATCG"),
                    "IIIIIIIIIIIIIIII"),
                FASTX.FASTQ.Record("read2", BioSequences.LongDNA{4}("GCTAGCTAGCTAGCTA"),
                    "IIIIIIIIIIIIIIII")
            ]
        ...
        Test.@testset "Environment Step with Mock Actions" begin
            ...
            test_reads = [
                FASTX.FASTQ.Record(
                    "read1", BioSequences.LongDNA{4}("ATCGATCGATCGATCGATCGATCGATCG"),
                    "IIIIIIIIIIIIIIIIIIIIIIIIIIII"),
                FASTX.FASTQ.Record(
                    "read2", BioSequences.LongDNA{4}("GCTAGCTAGCTAGCTAGCTAGCTAGCTA"),
                    "IIIIIIIIIIIIIIIIIIIIIIIIIIII")
            ]
            ...
            try
                ...
                final_state, final_reward,
                done3 = Mycelia.step_environment!(env, terminate_action)
    ...
    Test.@testset "Policy Management" begin
        ...
        Test.@testset "Action Selection" begin
            ...
            state = Mycelia.AssemblyState(
                21, 0.8, 0.1, 0.3, 0.8, 0.7, 0.9, [], [21], 50, 10.0)
        ...
        Test.@testset "Action Selection with High Correction Rate" begin
            ...
            high_correction_state = Mycelia.AssemblyState(
                21, 0.8, 0.1, 0.3, 0.8, 0.7, 0.9, [], [21], 50, 10.0)
        ...
        Test.@testset "Action Selection with High K" begin
            ...
            high_k_state = Mycelia.AssemblyState(
                97, 0.8, 0.01, 0.3, 0.8, 0.7, 0.1, [], [21, 31, 97], 5, 100.0)
    ...
    Test.@testset "Integration Functions" begin
        Test.@testset "Minimal Training" begin
            ...
            try
                ...
                policy,
                rewards = Mycelia.train_assembly_agent(
                    [train_file], [val_file],
                    episodes = 2,
                    episode_length = 3
                )
    ...
    Test.@testset "Performance and Resource Management" begin
        Test.@testset "Memory Usage Tracking" begin
            ...
            policy = Mycelia.create_dqn_policy()
            state = Mycelia.AssemblyState(
                21, 0.8, 0.05, 0.3, 0.8, 0.7, 0.9, [], [21], 50, 10.0)
