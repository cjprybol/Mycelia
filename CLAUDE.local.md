...
**YOU ARE IN: `mycelia/polecats/nux/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/mycelia/` (rig root) or other directories
...
**Your mail address:** `mycelia/polecats/nux`
**Your rig:** mycelia
**Your Witness:** `mycelia/witness`
...
| Ask Witness for help | `gt mail send mycelia/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`mycelia/witness`) when:
...
```bash
gt mail send mycelia/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
