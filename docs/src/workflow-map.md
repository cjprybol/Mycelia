...
| FASTQ (assembly)                                           | `Mycelia.Rhizomorph.assemble_genome`, `Mycelia.Rhizomorph.assemble_hybrid` → external assembler adapters                                                                                                                | MEGAHIT, metaSPAdes, SPAdes, Flye/metaFlye, hifiasm, Canu, SKESA, Unicycler, Autocycler; single-tech metaMDBG | Contig/scaffold FASTA, assembly logs, GFA/FASTG graphs, corrected-read provenance                         | [Genome Assembly](generated/tutorials/04_genome_assembly.md)                                                                                                 |
