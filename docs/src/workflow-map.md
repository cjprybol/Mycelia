...
| FASTQ (assembly)                                           | `Mycelia.Rhizomorph.assemble_genome`, `Mycelia.Rhizomorph.assemble_hybrid`, `Mycelia.Rhizomorph.assemble_unicycler_hybrid`, `Mycelia.Rhizomorph.assemble_autocycler_polished`; single-tech `Mycelia.run_metamdbg`                                                                         | MEGAHIT, metaSPAdes, SPAdes, Flye/metaFlye, hifiasm, Canu, SKESA, Unicycler, Autocycler; single-tech metaMDBG | Contig/scaffold FASTA, assembly logs, GFA/FASTG graphs, corrected-read provenance                         | [Genome Assembly](generated/tutorials/04_genome_assembly.md), [Tool Integration](generated/tutorials/08_tool_integration.md#wrapper-entry-points)                                                                          |
...
| --- | --- | --- | --- |
| `autocycler.jl` | `install_autocycler`, `run_autocycler`, `run_autocycler_polished` | Autocycler, Polypolish, Pypolca | Long-read Autocycler consensus, with an optional explicit paired-short polishing workflow. |
