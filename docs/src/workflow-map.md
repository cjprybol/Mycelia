...
| FASTQ (assembly)                                           | `Mycelia.Rhizomorph.assemble_genome`, `Mycelia.Rhizomorph.assemble_hybrid`, `Mycelia.Rhizomorph.assemble_unicycler_hybrid`, `Mycelia.Rhizomorph.assemble_autocycler_polished`; single-tech `Mycelia.run_metamdbg`                                                                         | MEGAHIT, metaSPAdes, SPAdes, Flye/metaFlye, hifiasm, Canu, SKESA, Unicycler, Autocycler, BWA, Polypolish, Pypolca; metaMDBG for exactly one technology: one or more HiFi FASTQs **or** one or more explicitly attested ONT R10.4-or-later FASTQs, never mixed or Illumina-plus-long | Contig/scaffold FASTA, assembly logs, GFA/FASTG graphs, corrected-read provenance                         | [Genome Assembly](generated/tutorials/04_genome_assembly.md), [Tool Integration](generated/tutorials/08_tool_integration.md#wrapper-entry-points)                                                                          |
...
| Assembly              | `Mycelia.Rhizomorph.assemble_genome`, `Mycelia.Rhizomorph.assemble_hybrid`, `Mycelia.Rhizomorph.assemble_unicycler_hybrid`, `Mycelia.Rhizomorph.assemble_autocycler_polished`, `Mycelia.run_metamdbg`, `Mycelia.mycelia_iterative_assemble` | Single or multiple FASTQ read sets under typed configs; metaMDBG accepts exactly one technology with one or more HiFi FASTQs **or** one or more explicitly attested ONT R10.4-or-later FASTQs; it rejects mixed technologies and Illumina-plus-long input | Contigs/scaffolds, assembly graphs, corrected-read/tool provenance             | External assemblers + native graphs                              |
...
| --- | --- | --- | --- |
| `autocycler.jl` | `install_autocycler`, `run_autocycler`, `run_autocycler_polished` | Autocycler, BWA, Polypolish, Pypolca | Long-read Autocycler consensus, with an optional explicit paired-short polishing workflow. |
