...
| FASTQ (assembly)                                           | `Mycelia.Rhizomorph.assemble_genome`, `Mycelia.Rhizomorph.assemble_hybrid`, `Mycelia.Rhizomorph.assemble_dual_long` → external assembler adapters                                                        | MEGAHIT, metaSPAdes, SPAdes, Flye/metaFlye, hifiasm, Canu, SKESA, Unicycler, Autocycler, metaMDBG    | Contig/scaffold FASTA, assembly logs, GFA/FASTG graphs, corrected-read provenance                         | [Genome Assembly](generated/tutorials/04_genome_assembly.md)                                                                                                 |
...
| Assembly              | `Mycelia.Rhizomorph.assemble_genome`, `Mycelia.Rhizomorph.assemble_hybrid`, `Mycelia.Rhizomorph.assemble_dual_long`, `Mycelia.mycelia_iterative_assemble`                                      | Single or multiple FASTQ read sets, typed config                         | Contigs/scaffolds, assembly graphs, corrected-read/tool provenance             | External assemblers + native graphs                              |
